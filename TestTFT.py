...
def main():
    ...
    # Splitting the data
    train_data = merged_data[-3000:-130].reset_index(drop=True)
    val_data = merged_data[-3000:-65].reset_index(drop=True)
    ...
    # val_dataloader = validation.to_dataloader(train=False, batch_size=480, num_workers=8)
